...
var _user$project$Model$daysUntilEndOfWeek = function (day) {
	var _p0 = day;
	switch (_p0.ctor) {
		case 'Sun':
			return 6;
...
var _user$project$Model$dateFromTuple = function (_p1) {
	var _p2 = _p1;
	return A7(_rluiten$elm_date_extra$Date_Extra_Create$dateFromFields, _p2._2, _p2._0, _p2._1, 0, 0, 0, 0);
};
var _user$project$Model$firstDates = F2(
	function (first, _p3) {
		var _p4 = _p3;
		var range = _elm_lang$core$Native_List.range(1, first);
		return A2(
			_elm_lang$core$List$map,
			function (day) {
				return _user$project$Model$dateFromTuple(
					{ctor: '_Tuple3', _0: _p4._0, _1: day, _2: _p4._1});
			},
			range);
	});
var _user$project$Model$lastDates = F2(
	function (last, _p5) {
		var _p6 = _p5;
		var _p8 = _p6._1;
		var _p7 = _p6._0;
		var end = A2(_rluiten$elm_date_extra$Date_Extra_Core$daysInMonth, _p8, _p7);
		var start = (end - last) + 1;
		var range = _elm_lang$core$Native_List.range(start, end);
		return A2(
			_elm_lang$core$List$map,
			function (day) {
				return _user$project$Model$dateFromTuple(
					{ctor: '_Tuple3', _0: _p7, _1: day, _2: _p8});
			},
			range);
	});
var _user$project$Model$nextMonthAndYear = F2(
	function (month, year) {
		var _p9 = month;
		if (_p9.ctor === 'Dec') {
			return {ctor: '_Tuple2', _0: _elm_lang$core$Date$Jan, _1: year + 1};
		} else {
			return {
				ctor: '_Tuple2',
				_0: _rluiten$elm_date_extra$Date_Extra_Core$nextMonth(month),
				_1: year
			};
		}
	});
var _user$project$Model$previousMonthAndYear = F2(
	function (month, year) {
		var _p10 = month;
		if (_p10.ctor === 'Jan') {
			return {ctor: '_Tuple2', _0: _elm_lang$core$Date$Dec, _1: year - 1};
		} else {
			return {
				ctor: '_Tuple2',
				_0: _rluiten$elm_date_extra$Date_Extra_Core$prevMonth(month),
				_1: year
			};
		}
	});
var _user$project$Model$datesList = F2(
	function (month, year) {
		var firstDayOfMonth = _elm_lang$core$Date$dayOfWeek(
			_user$project$Model$dateFromTuple(
				{ctor: '_Tuple3', _0: month, _1: 1, _2: year}));
		var previousDates = A2(
			_user$project$Model$lastDates,
			A2(_rluiten$elm_date_extra$Date_Extra_Core$daysBackToStartOfWeek, firstDayOfMonth, _elm_lang$core$Date$Sun),
			A2(_user$project$Model$previousMonthAndYear, month, year));
		var daysCount = A2(_rluiten$elm_date_extra$Date_Extra_Core$daysInMonth, year, month);
		var lastDayOfMonth = _elm_lang$core$Date$dayOfWeek(
			_user$project$Model$dateFromTuple(
				{ctor: '_Tuple3', _0: month, _1: daysCount, _2: year}));
		var nextDates = A2(
			_user$project$Model$firstDates,
			_user$project$Model$daysUntilEndOfWeek(lastDayOfMonth),
			A2(_user$project$Model$nextMonthAndYear, month, year));
		var currentDates = A2(
			_user$project$Model$firstDates,
			daysCount,
			{ctor: '_Tuple2', _0: month, _1: year});
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				previousDates,
				A2(_elm_lang$core$Basics_ops['++'], currentDates, nextDates)));
	});
var _user$project$Model$Repeatex = F3(
	function (a, b, c) {
		return {repeatType: a, frequency: b, days: c};
	});
var _user$project$Model$Model = F4(
	function (a, b, c, d) {
		return {formatted: a, repeats: b, dates: c, current: d};
	});
var _user$project$Model$RepeatexDict = function (a) {
	return {ctor: 'RepeatexDict', _0: a};
};
var _user$project$Model$RepeatexNumbers = function (a) {
	return {ctor: 'RepeatexNumbers', _0: a};
};
var _user$project$Model$RepeatexList = function (a) {
	return {ctor: 'RepeatexList', _0: a};
};

var _user$project$Actions$NoAction = {ctor: 'NoAction'};
var _user$project$Actions$TimeLoaded = function (a) {
	return {ctor: 'TimeLoaded', _0: a};
};
var _user$project$Actions$ApiFailure = function (a) {
	return {ctor: 'ApiFailure', _0: a};
};
var _user$project$Actions$ApiSuccess = function (a) {
	return {ctor: 'ApiSuccess', _0: a};
};
var _user$project$Actions$Update = function (a) {
	return {ctor: 'Update', _0: a};
};

var _user$project$Decoder$date = A2(_elm_lang$core$Json_Decode$customDecoder, _elm_lang$core$Json_Decode$string, _elm_lang$core$Date$fromString);
var _user$project$Decoder$decodeAsListOfInts = function (days) {
	return _elm_lang$core$Json_Decode$succeed(
		_user$project$Model$RepeatexNumbers(days));
};
var _user$project$Decoder$decodeAsListOfStrings = function (days) {
	return _elm_lang$core$Json_Decode$succeed(
		_user$project$Model$RepeatexList(days));
};
var _user$project$Decoder$decodeAsDict = function (days) {
	return _elm_lang$core$Json_Decode$succeed(
		_user$project$Model$RepeatexDict(days));
};
var _user$project$Decoder$decodeDays = _elm_lang$core$Json_Decode$oneOf(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			_elm_lang$core$Json_Decode$andThen,
			_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string),
			_user$project$Decoder$decodeAsListOfStrings),
			A2(
			_elm_lang$core$Json_Decode$andThen,
			_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$int),
			_user$project$Decoder$decodeAsListOfInts),
			A2(
			_elm_lang$core$Json_Decode$andThen,
			_elm_lang$core$Json_Decode$dict(_elm_lang$core$Json_Decode$int),
			_user$project$Decoder$decodeAsDict)
		]));
var _user$project$Decoder$decodeParsed = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Model$Repeatex,
	...
	A2(_elm_lang$core$Json_Decode_ops[':='], 'days', _user$project$Decoder$decodeDays));
var _user$project$Decoder$decodeResponse = A5(
	_elm_lang$core$Json_Decode$object4,
	_user$project$Model$Model,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'formatted', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'parsed', _user$project$Decoder$decodeParsed),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'dates',
		_elm_lang$core$Json_Decode$list(_user$project$Decoder$date)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'current', _elm_lang$core$Json_Decode$float));
...
var _user$project$Encoder$repeatexEncoder = function (repeatex) {
	var _p2 = repeatex.days;
	switch (_p2.ctor) {
		case 'RepeatexList':
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'type',
						_1: _elm_lang$core$Json_Encode$string(repeatex.repeatType)
					},
						{
						ctor: '_Tuple2',
						_0: 'frequency',
						_1: _elm_lang$core$Json_Encode$int(repeatex.frequency)
					},
						{
						ctor: '_Tuple2',
						_0: 'days',
			...
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'days',
						_1: A2(_user$project$Encoder$dictEncoder, _elm_lang$core$Json_Encode$int, _p2._0)
					}
					]));
		default:
			return _elm_lang$core$Json_Encode$object(
					...
					[
						...
						_1: _elm_lang$core$Json_Encode$list(
							A2(
								_elm_lang$core$List$map,
								function (day) {
									return _elm_lang$core$Json_Encode$int(day);
								},
								_p2._0))
					}
					]));
...
var _user$project$Encoder$format = function (repeatex) {
	return A2(
		_elm_lang$core$Json_Encode$encode,
		2,
		_user$project$Encoder$repeatexEncoder(repeatex));
};

var _user$project$View$formatMonth = function (month) {
	var _p0 = month;
	switch (_p0.ctor) {
		case 'Jan':
			return 'January';
...
var _user$project$View$dateHeaderTitle = F2(
	function (month, year) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$View$formatMonth(month),
			A2(
				_elm_lang$core$Basics_ops['++'],
				' ',
				_elm_lang$core$Basics$toString(year)));
	});
var _user$project$View$dateToTuple = function (date) {
	return {
		ctor: '_Tuple3',
		_0: _elm_lang$core$Date$month(date),
		_1: _elm_lang$core$Date$day(date),
		_2: _elm_lang$core$Date$year(date)
	};
};
var _user$project$View$selectedDate = F2(
	function (model, date) {
		var evaluator = function (existing) {
			return _elm_lang$core$Native_Utils.eq(
				_user$project$View$dateToTuple(existing),
				_user$project$View$dateToTuple(date));
		};
		return A2(_elm_lang$core$List$any, evaluator, model.dates);
	});
var _user$project$View$dateCellClass = F3(
	function (model, date, _p1) {
		var _p2 = _p1;
		var selected = A2(_user$project$View$selectedDate, model, date) ? ' calendar__cell--selected' : '';
		var outside = _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Date$month(date),
			_p2._0) ? '' : ' calendar__cell--outside';
		return A2(_elm_lang$core$Basics_ops['++'], outside, selected);
	});
var _user$project$View$dateCell = F3(
	function (model, date, monthTuple) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						'calendar__cell',
						A3(_user$project$View$dateCellClass, model, date, monthTuple)))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$View$dateRow = F3(
	function (model, dates, monthTuple) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('calendar__row')
				]),
			A2(
				_elm_lang$core$List$map,
				function (date) {
					return A3(_user$project$View$dateCell, model, date, monthTuple);
				},
				dates));
	});
var _user$project$View$dateHeader = F2(
	function (_p3, model) {
		var _p4 = _p3;
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('calendar__header')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							A2(_user$project$View$dateHeaderTitle, _p4._0, _p4._1))
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('calendar__days')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('calendar__day')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Su')
								])),
							A2(
							_elm_lang$html$Html$span,
							_elm_lang$core$Native_List.fromArray(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Sa')
								]))
						]))
				]));
	});
var _user$project$View$dateCalendar = F2(
	function (_p5, model) {
		var _p6 = _p5;
		var _p8 = _p6._1;
		var _p7 = _p6._0;
		var datesForCalendar = A2(_user$project$Model$datesList, _p7, _p8);
		return A2(
			_elm_lang$html$Html$td,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('calendar')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_user$project$View$dateHeader,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('calendar__content')
						]),
					A2(
						_elm_lang$core$List$map,
						function (dates) {
							return A3(
								_user$project$View$dateRow,
								model,
								dates,
								{ctor: '_Tuple2', _0: _p7, _1: _p8});
						},
...
var _user$project$View$parsed = function (model) {
	var parsedString = _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$String$length(model.formatted),
		0) ? 'None' : _user$project$Encoder$format(model.repeats);
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(parsedString)
			]));
};
var _user$project$View$calendarRows = F2(
	function (model, monthTuples) {
		var grouped = A2(_elm_community$list_extra$List_Extra$groupsOf, 2, monthTuples);
		var calendarFrom = function (monthTuple) {
			return A2(_user$project$View$dateCalendar, monthTuple, model);
		};
		var rowFromTuples = function (twoTuples) {
			return A2(
				_elm_lang$html$Html$tr,
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$map, calendarFrom, twoTuples));
		};
		var rows = A2(_elm_lang$core$List$map, rowFromTuples, grouped);
		return A2(
...
var _user$project$View$nextMonthTime = function (existing) {
	var last = function () {
		var _p9 = _elm_community$list_extra$List_Extra$last(existing);
		if (_p9.ctor === 'Just') {
			return _rluiten$elm_date_extra$Date_Extra_Core$lastOfMonthDate(
				_elm_lang$core$Date$fromTime(_p9._0));
		} else {
			return _elm_lang$core$Date$fromTime(0);
		}
	}();
	var nextDayTime = _elm_lang$core$Date$toTime(last) + _elm_lang$core$Basics$toFloat(_rluiten$elm_date_extra$Date_Extra_Core$ticksADay);
	return A2(
		_elm_lang$core$Basics_ops['++'],
		existing,
		_elm_lang$core$Native_List.fromArray(
...
var _user$project$View$monthTuplesFrom = function (current) {
	var tupleFromTime = function (time) {
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Date$month(
				_elm_lang$core$Date$fromTime(time)),
			_1: _elm_lang$core$Date$year(
				_elm_lang$core$Date$fromTime(time))
		};
	};
	var times = _user$project$View$nextMonthTime(
		_user$project$View$nextMonthTime(
			_user$project$View$nextMonthTime(
				_user$project$View$nextMonthTime(
					_elm_lang$core$Native_List.fromArray(
						[current])))));
	return A2(_elm_lang$core$List$map, tupleFromTime, times);
};
var _user$project$View$view = function (model) {
	var monthTuples = _user$project$View$monthTuplesFrom(model.current);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Try it!')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$placeholder('on wednesday every week'),
						_elm_lang$html$Html_Events$onInput(_user$project$Actions$Update)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Generated Dates')
					])),
				A2(
				_elm_lang$html$Html$table,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('table--calendar')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
...
var _user$project$Main$getRepeatex = function (input) {
	var url = A2(_elm_lang$core$Basics_ops['++'], '/api?value=', input);
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Actions$ApiFailure,
		_user$project$Actions$ApiSuccess,
		A2(_evancz$elm_http$Http$get, _user$project$Decoder$decodeResponse, url));
};
var _user$project$Main$subscriptions = function (_p0) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Main$init = function () {
	var task = _elm_lang$core$Time$now;
	var repeatex = A3(
		_user$project$Model$Repeatex,
		'daily',
		1,
		_user$project$Model$RepeatexList(
			_elm_lang$core$Native_List.fromArray(
				[])));
	return {
		ctor: '_Tuple2',
		...
		_1: A3(
			_elm_lang$core$Task$perform,
			function (_p1) {
				return _user$project$Actions$NoAction;
			},
			_user$project$Actions$TimeLoaded,
			task)
	};
}();
		...
		switch (_p2.ctor) {
			case 'Update':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$getRepeatex(_p2._0)
				};
			case 'ApiSuccess':
...
;require.register("web/elm/Decoder", function(exports, require, module) {

});

;require.register("web/elm/Encoder", function(exports, require, module) {
...
;require.register("web/elm/Model", function(exports, require, module) {

});

;require.register("web/elm/View", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/Bogdanp/elm-datepicker/3.0.0/examples/bootstrap/Bootstrap", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/Bogdanp/elm-datepicker/3.0.0/examples/simple/Simple", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/Bogdanp/elm-datepicker/3.0.0/src/DatePicker", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/Bogdanp/elm-datepicker/3.0.0/src/DatePicker/Date", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-community/list-extra/2.0.1/src/List/Extra", function(exports, require, module) {
...
require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/examples/ExampleCompare", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/examples/ExampleConfigFormat", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/examples/ExampleFormat", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/Compare", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/Config", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/Config/Config_en_au", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/Config/Config_en_gb", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/Config/Config_en_us", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/Config/Config_fr_fr", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/Config/Configs", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/Core", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/Create", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/Duration", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/Field", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/Format", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/I18n/I_en_us", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/I18n/I_fr_fr", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/Internal", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/Period", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/TimeUnit", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/src/Date/Extra/Utils", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/tests/Date/Extra/CompareTests", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/tests/Date/Extra/ConfigTests", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/tests/Date/Extra/ConvertingTests", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/tests/Date/Extra/CoreTests", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/tests/Date/Extra/CreateTests", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/tests/Date/Extra/DurationTests", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/tests/Date/Extra/FieldTests", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/tests/Date/Extra/FormatTests", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/tests/Date/Extra/PeriodTests", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/tests/Date/Extra/TimeUnitTests", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/tests/Date/Extra/UtilsTests", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/tests/TestRunner", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/rluiten/elm-date-extra/6.1.0/tests/TestUtils", function(exports, require, module) {
...
var elmDiv = document.getElementById('demo');
