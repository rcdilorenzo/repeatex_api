...
var _user$project$Decoder$decodeResponse = A3(
...
var _user$project$Main$ApiFailure = function (a) {
		...
		switch (_p1.ctor) {
			case 'Update':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$getRepeatex(_p1._0)
				};
			case 'ApiSuccess':
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onInput(_user$project$Main$Update)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$Encoder$format(model.repeats))
					])),
				A2(
				_elm_lang$html$Html$h3,
				_elm_lang$core$Native_List.fromArray(
